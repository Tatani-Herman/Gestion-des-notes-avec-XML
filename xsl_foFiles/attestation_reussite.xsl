            ...
            <fo:block font-size="13pt" margin-top="2mm" space-after="5mm" text-align="center" font-weight="bold">
              ...
              <fo:block margin-left="8cm">
               ...
               <!-- <fo:table font-size="13pt" margin-left="5cm" border-color="black" border-width="0.4mm" border-style="solid" height="0.7cm" space-after="15mm">
                 ...
                 <fo:external-graphic src="url(C://xamp/htdocs/Gestion-des-notes-avec-XML/img/entatt.PNG)"/>
                 </fo:block>
                ...
                <fo:block text-align="center" space-after="2mm" font-weight="bold">Monsieur <fo:inline font-size="12pt"><xsl:value-of select="FirstName"/><xsl:text> </xsl:text> <xsl:value-of select="LastName"/></fo:inline></fo:block>
                <fo:block text-align="center" space-after="2mm">né le <xsl:value-of select="DateofBirth"/><xsl:text> à TANGER</xsl:text></fo:block>
                ...
                <fo:block margin-left="0.5cm" space-after="15cm">
                 <fo:external-graphic src="url(C://xamp/htdocs/Gestion-des-notes-avec-XML/img/trait.PNG)"/>
                 </fo:block> 
                ...
                <fo:block margin-left="5mm" space-after="1cm">N° étudiant: <xsl:value-of select="CNE"/></fo:block>
