...
page-height="29.7cm" master-name="simpleA4">
	...
	<fo:region-before region-name="xsl-region-before" extent="25mm"  display-align="before" precedence="true"/>
            ...
            <fo:static-content flow-name="xsl-region-before" fon-size="10pt">
            <fo:block font-size="13pt" margin-top="2mm" space-after="5mm" text-align="center" font-weight="bold">
              ...
              <fo:block margin-left="8cm">
               ...
               <!-- <fo:table font-size="13pt" margin-left="5cm" border-color="black" border-width="0.4mm" border-style="solid" height="0.7cm" space-after="15mm">
                ...
                <fo:block text-align="center" space-after="2mm" font-weight="bold">Monsieur <fo:inline font-size="12pt"><xsl:value-of select="students/student[position()=1]/FirstName"/><xsl:text> </xsl:text> <xsl:value-of select="students/student[position()=1]/LastName"/></fo:inline></fo:block>
                <fo:block text-align="center" space-after="2mm">né le <xsl:value-of select="students/student[position()=1]/DateofBirth"/><xsl:text> à TANGER</xsl:text></fo:block>
