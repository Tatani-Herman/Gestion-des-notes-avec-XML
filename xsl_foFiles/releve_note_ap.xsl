  ...
  <xsl:template match="note">
    <fo:root>
      ...
      <fo:page-sequence master-reference="simpleA4">
        ...
        <fo:block space-after="1.5mm" margin-left="0.5cm">Inscrit en<xsl:text> </xsl:text> <fo:inline margin-left="2mm" font-weight="bold" font-size="13pt">2° Année cycle préparatoire</fo:inline>
        </fo:block>
      ...
      <fo:flow flow-name="xsl-region-body">
        <fo:block>
          ...
          <fo:block space-after="6cm" space-before="1.5mm" font-weight="bold" margin-left="0.5cm" font-size="11pt">Résultat d'admission session 1:<fo:inline padding-left="3.6cm">
            ...
            <!-- Test si la moyenne superieur a 10 pour valider (car l'etudiant est en cycle preparatoire)-->
          <xsl:choose>
